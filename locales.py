...
TRANSLATIONS = {
    'ru': {
        ...
        'help.feed': 'Лента',
        'help.feed_desc': 'Гибкий режим для тех, кто хочет изучать темы в своём темпе. Вы выбираете до 3 тем на неделю и получаете ежедневные дайджесты с углублением. После каждого дайджеста — фиксация (ваш личный вывод).',
    ...
    'en': {
        ...
        'help.feed': 'Feed',
        'help.feed_desc': 'Flexible mode for those who want to study topics at their own pace. You choose up to 3 topics per week and receive daily digests with deepening. After each digest — a fixation (your personal takeaway).',
    ...
    'es': {
        ...
        'help.feed': 'Feed',
        'help.feed_desc': 'Modo flexible para quienes quieren estudiar temas a su propio ritmo. Eliges hasta 3 temas por semana y recibes resúmenes diarios con profundización. Después de cada resumen — una fijación (tu conclusión personal).',
