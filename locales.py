...
TRANSLATIONS = {
    'ru': {
        ...
        'welcome.current_mode': 'Режим',
        'welcome.activity_progress': 'Активность',
        ...
        'help.marathon_desc': '14-дневная структурированная программа. Каждый день — урок (теория + вопрос) и задание с рабочим продуктом. Темы идут последовательно.',
        'help.feed': 'Лента',
        'help.feed_desc': 'Гибкий режим для тех, кто хочет изучать темы в своём темпе без ограничений по дедлайнам. Вы выбираете до 3 тем и получаете ежедневные дайджесты. После каждого дайджеста — фиксация (ваш личный вывод).',
        'help.ai_questions': 'В обоих режимах работает функция вопроса к ИИ. Начните сообщение с ? чтобы задать вопрос.',
        'help.ai_questions_example': 'Пример: ?Что такое собранность?',
        'help.commands_title': 'Основные команды',
        'help.feed_cmd': 'получить дайджест (Лента)',
        'help.how_it_works': 'Как использовать бот',
        'help.step1': '1. Вы заранее устанавливаете режим, время получения контента и т.п.',
        'help.step2': '2. Я отправляю персонализированный материал',
        'help.step3': '3. Вы изучаете его (5-25 мин)',
        'help.step4': '4. Отвечаете на вопрос или пишете фиксацию',
        'help.step5': '5. День засчитывается в прогресс',
        'help.schedule_note': 'Рекомендуется установить время получения контента — так вы не будете ждать слишком долго. Или запросите его командой, но подождите примерно 1 минуту. Бот в это время формирует динамический контекст для обращения к ИИ, используя ваши данные и обращаясь к хранилищам данных МИМ.',
        ...
        'marathon.next_task': 'Дальше — Задание',
        'marathon.next_lesson': 'Дальше — Урок',
        'marathon.want_harder': 'Хотите дополнительный вопрос посложнее?',
        'marathon.next_command': '/learn — следующая тема',
        'marathon.continue_to_task': '/learn — перейти к заданию',
        'marathon.continue_to_lesson': '/learn — перейти к уроку',
        ...
        'marathon.loading_practice': 'Переходим к заданию...',
        'marathon.day_complete': 'День завершён! Возвращайтесь завтра.',
        'marathon.practice_accepted': 'Практика засчитана!',
    ...
    'en': {
        ...
        'welcome.current_mode': 'Mode',
        'welcome.activity_progress': 'Activity',
        ...
        'help.marathon_desc': '14-day structured program. Each day — a lesson (theory + question) and a task with deliverable. Topics go sequentially.',
        'help.feed': 'Feed',
        'help.feed_desc': 'Flexible mode for those who want to study topics at their own pace without deadline restrictions. You choose up to 3 topics and receive daily digests. After each digest — a fixation (your personal takeaway).',
        'help.ai_questions': 'In both modes, you can ask questions to AI. Start your message with ? to ask.',
        'help.ai_questions_example': 'Example: ?What is self-discipline?',
        'help.commands_title': 'Main commands',
        'help.feed_cmd': 'get digest (Feed)',
        'help.how_it_works': 'How to use the bot',
        'help.step1': '1. You set up mode, content delivery time, etc.',
        'help.step2': '2. I send personalized material',
        'help.step3': '3. You study it (5-25 min)',
        'help.step4': '4. Answer a question or write a fixation',
        'help.step5': '5. Day counts toward progress',
        'help.schedule_note': "It's recommended to set content delivery time — so you don't wait too long. Or request it via command, but wait about 1 minute. The bot creates dynamic context for AI, using your data and MIM knowledge bases.",
        ...
        'marathon.next_task': 'Next — Task',
        'marathon.next_lesson': 'Next — Lesson',
        'marathon.want_harder': 'Want a harder bonus question?',
        'marathon.next_command': '/learn — next topic',
        'marathon.continue_to_task': '/learn — continue to task',
        'marathon.continue_to_lesson': '/learn — continue to lesson',
        ...
        'marathon.loading_practice': 'Moving to the practice task...',
        'marathon.day_complete': 'Day complete! See you tomorrow.',
        'marathon.practice_accepted': 'Practice completed!',
    ...
    'es': {
        ...
        'welcome.current_mode': 'Modo',
        'welcome.activity_progress': 'Actividad',
        ...
        'help.feed': 'Feed',
        'help.feed_desc': 'Modo flexible para quienes quieren estudiar temas a su propio ritmo sin restricciones de plazos. Eliges hasta 3 temas y recibes resúmenes diarios. Después de cada resumen — una fijación (tu conclusión personal).',
        'help.ai_questions': 'En ambos modos, puedes hacer preguntas a la IA. Comienza tu mensaje con ? para preguntar.',
        'help.ai_questions_example': 'Ejemplo: ?¿Qué es la autodisciplina?',
        'help.commands_title': 'Comandos principales',
        'help.feed_cmd': 'obtener resumen (Feed)',
        'help.how_it_works': 'Cómo usar el bot',
        'help.step1': '1. Configuras el modo, hora de contenido, etc.',
        'help.step2': '2. Envío material personalizado',
        'help.step3': '3. Lo estudias (5-25 min)',
        'help.step4': '4. Respondes una pregunta o escribes una fijación',
        'help.step5': '5. El día cuenta para tu progreso',
        'help.schedule_note': 'Se recomienda establecer la hora de contenido — así no esperas demasiado. O solicítalo con un comando, pero espera aproximadamente 1 minuto. El bot crea contexto dinámico para la IA, usando tus datos y las bases de conocimiento MIM.',
        ...
        'marathon.next_task': 'Siguiente — Tarea',
        'marathon.next_lesson': 'Siguiente — Lección',
        'marathon.want_harder': '¿Quieres una pregunta extra más difícil?',
        'marathon.next_command': '/learn — próximo tema',
        'marathon.continue_to_task': '/learn — continuar a la tarea',
        'marathon.continue_to_lesson': '/learn — continuar a la lección',
        ...
        'marathon.loading_practice': 'Pasando a la tarea práctica...',
        'marathon.day_complete': '¡Día completado! Vuelve mañana.',
        'marathon.practice_accepted': '¡Práctica completada!',
