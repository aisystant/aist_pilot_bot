...
> **[tests/testing-scenarios.md](tests/testing-scenarios.md)** — Полный чек-лист сценариев тестирования (121 сценарий)
...
- **[tests/testing-scenarios.md](tests/testing-scenarios.md)** — Сценарии тестирования
